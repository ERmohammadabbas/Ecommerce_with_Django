...
from . forms import CustomerRegistrationForm,CustomerProfileForm,Customer,PasswordChangeForm
...
class CategoryView(View):
  @method_decorator(login_required,name='display')
